...
public interface ScoreMyBatisMapper {
    ...
    // 점수 저장 기능
    @Insert("INSERT INTO tbl_score " + "(stu_num, name, kor, eng, math, total, average)" + "VALUES(seq_score.nextval,#{score.name},#{score.kor},#{score.eng},#{score.math},#{score.total},#{score.average})")
