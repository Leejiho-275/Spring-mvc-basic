...
import com.spring.mvc.springweb.score.repository.TemplateScoreRepository;
...
public class TemplateBoardRepository implements BoardRepository {
    ...
    public List<Board> getArticles() {
        ...
        return template.query(sql, new TemplateBoardRepository.BoardMapper());
    }

    @Override
    public void insertArticle(Board article) {
        String sql = "INSERT INTO tbl_board " + "(board_no, writer, title, content) " + " VALUES(seq_board.nextval,?,?,?) ";
